...
class Learning extends Model{
    ...
    private $dbColums=['dars_id','day','lesson','time_start','time_end'];
    ...
    public function get(){
        $_p=$this->Pagination();
        $D=Application::$app->db->query('SELECT `d`.`name` `dname`,`l`.`id`,`l`.`day`,`l`.`lesson`,`l`.`time_start`,`l`.`time_end`,`l`.`deleted`
    ...
    public function insert(){
        ...
        $this->setLog('learning','add',$last_id);
        return $last_id;
    }
