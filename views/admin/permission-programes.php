<div class="d-md-flex align-items-center">
    <div class="col-md-6">
        <a class="btn btn-sm btn-bg mh40 p-0 px-2" href="/cp/permission/program/add">
...
<ul class="responsive-table2 fmedium my-2">
    <li class="table-header">
        <div class="col col-3">العنوان</div>
 ...
 foreach ($data as $d):?>
        <li class="table-row shadow">
            <div class="col col-3" data-label="العنوان"><?=$d['title']?></div>
            <div class="col col-2" data-label="الاسم"><?=$d['name']?></div>
            <div class="col col-1" data-label="العمليات">
                <div class="menu-tools">
                    <div class="tools-content">
                        <a href="/cp/permission/program/edit/<?=$d['id']?>" class="mx-1 btn btn-sm btn-primary">تعديل</a>
                        <?php if( $d['deleted']==0):?>
                        <buttonn onclick="DeleteBtnAlert('/cp/permission/program/delete/<?=$d['id']?>')" class="mx-1 btn btn-sm btn-danger">حذف</buttonn>
                        <?php else:?>
                        <a href="/cp/permission/program/restore/<?=$d['id']?>" class="mx-1 btn btn-sm btn-warning">استرجاع</a>
                        <?php endif;?>
                    </div>
                </div>
            </div>
