...
<div class="d-md-flex align-items-center">
    <div class="col-md-6">
        <a class="btn btn-sm btn-bg mh40 p-0 px-2" href="/cp/permission/action/add">
            ...
            <div class="col col-1" data-label="العمليات">
                <div class="menu-tools">
                    <div class="tools-content">
                        <a href="/cp/permission/action/edit/<?=$d['id']?>" class="mx-1 btn btn-sm btn-primary">تعديل</a>
                        <?php if( $d['deleted']==0):?>
                        <buttonn onclick="DeleteBtnAlert('/cp/permission/action/delete/<?=$d['id']?>')" class="mx-1 btn btn-sm btn-danger">حذف</buttonn>
                        <?php else:?>
                        <a href="/cp/permission/action/restore/<?=$d['id']?>" class="mx-1 btn btn-sm btn-warning">استرجاع</a>
                        <?php endif;?>
                    </div>
                </div>
            </div>
